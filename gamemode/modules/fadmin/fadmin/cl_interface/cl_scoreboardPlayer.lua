...
function FAdmin.ScoreBoard.Player.Show(ply)
    ...
    if(IsValid(FAdmin.ScoreBoard.Player.Controls.Background)) then FAdmin.ScoreBoard.Player.Controls.Background:Remove() end
    FAdmin.ScoreBoard.Player.Controls.Background = vgui.Create("Panel")
    FAdmin.ScoreBoard.Player.Controls.Background:SetPos(FAdmin.ScoreBoard.X, FAdmin.ScoreBoard.Y+85)
    FAdmin.ScoreBoard.Player.Controls.Background.Paint = function(self,w,h)
        surface.SetDrawColor(0,0,0,180)
        surface.DrawRect(0,0,w,h)
    end
 
    FAdmin.ScoreBoard.Player.Controls.Background:SetSize(FAdmin.ScoreBoard.Width,ScrH()-260)
    FAdmin.ScoreBoard.Player.Controls.Background:SetZPos(-30000)
