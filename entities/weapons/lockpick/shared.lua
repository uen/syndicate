...
function SWEP:DrawHUD()
    ...
    draw.RoundedBoxEx(8, x, y, width, height, Color(10,10,10,120),false,false,false,false)
    ...
    draw.RoundedBoxEx(cornerRadius, x + 8, y + 8, BarWidth, height - 16, Color(255 - (status * 255), 0 + (status * 255), 0, 255), false,false,false,fase)
